...
#if defined(ALIAN_MEMORY)
    double *A = (double *)_mm_malloc(MAX_SIZE * MAX_SIZE * sizeof(double), alain_bits);
    double *B = (double *)_mm_malloc(MAX_SIZE * MAX_SIZE * sizeof(double), alain_bits);
    double *C = (double *)_mm_malloc(MAX_SIZE * MAX_SIZE * sizeof(double), alain_bits);
#else
